...
const theme = createTheme({
  ...
  components: {
    ...
    MuiButton: {
      ...
      styleOverrides: {
        sizeLarge: {
          ...
          fontWeight: 700,
          backgroundColor: '#17d161',
          '&:hover': { backgroundColor: '#1b8777' },
        },
        sizeSmall: {
          padding: '4px 0px',
          '@media (min-width:900px)': { padding: '4px 8px' },
        },
      },
      variants: [
        {
    ...
    MuiPopover: {
      styleOverrides: {
        paper: { boxShadow: '0px 4px 20px rgba(0, 0, 0, 0.5)' },
      },
    },
    MuiContainer: {
      styleOverrides: {
    ...
    MuiDivider: {
      styleOverrides: {
        root: { borderColor: 'rgba(194, 224, 255, 0.08)' },
      },
    },
    MuiLink: {
    ...
    MuiToggleButtonGroup: {
      styleOverrides: { root: { backgroundColor: '#171414' } },
    },
    MuiToggleButton: {
      styleOverrides: {
        root: {
          ...
          '&.Mui-selected': {
            color: '#fff',
            borderColor: '#0a6338 !important',
            backgroundColor: '#1a826a',
            '&:hover': { backgroundColor: '#158f5a' },
          },
        },
      },
    },
  ...
  palette: {
    ...
    secondary: {
      ...
      dark: 'rgb(102, 178, 255)',
    },
    divider: 'rgba(194, 224, 255, 0.08)',
    background: { default: 'radial-gradient(circle, rgba(17,17,23,1) 0%, rgba(54,14,140,1) 80%, rgba(23,47,47,1) 100%)', paper: '#171414' },
  ...
  // @ts-ignore
  custom: {
    containerHeight: `calc(100vh - ${HEADER_HEIGHT})`,
  },
});
